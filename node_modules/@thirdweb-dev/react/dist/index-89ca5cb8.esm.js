import { ethers, utils, providers, constants, BigNumber } from 'ethers';
import invariant from 'tiny-invariant';
import { Connector, normalizeChainId, WagmiProvider, useProvider, useSigner as useSigner$1, useContext as useContext$1, useAccount as useAccount$1, useNetwork as useNetwork$1, useConnect as useConnect$1 } from 'wagmi';
import { ChainId, NATIVE_TOKENS, UserWallet, ThirdwebSDK, getProviderForNetwork, ListingType, SUPPORTED_CHAIN_IDS } from '@thirdweb-dev/sdk';
...
import { Q as QueryClientProviderWithDefault, n as neverPersist } from './query-key-df02df0e.esm.js';
...
const ThirdwebSDKProvider = _ref2 => {
  ...
  return /*#__PURE__*/jsx(ThirdwebConnectedWalletProvider, {
    signer: signer,
    children: /*#__PURE__*/jsx(WrappedThirdwebSDKProvider, { ...restProps,
      children: children
    })
  });
};
...
function useContract(contractAddress, contractTypeOrABI) {
  ...
  neverPersist(["contract-instance", contractAddress, {
    ...
    invariant(activeChainId, "active chain id is required"); // if we don't have a contractType or ABI then we will have to resolve it regardless
    ...
    if (!contractTypeOrABI || contractTypeOrABI === "custom") {
      ...
      invariant(resolvedContractType, "failed to resolve contract type"); // just let the sdk handle the rest
...
function useTransferNFT(contract) {
  ...
  return useMutation(data => {
    ...
    if (erc1155) {
      ...
      invariant("tokenId" in data, "tokenId not provided");
      invariant("amount" in data, "amount not provided"); // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
...
function useUnclaimedNFTs(contract, queryParams) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.nft.drop.getAllUnclaimed(contractAddress, queryParams), () => {
    invariant(contract, "No Contract instance provided"); // TODO make this work for custom contracts (needs ABI change)
...
function useUnclaimedNFTSupply(contract) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.nft.drop.totalUnclaimedSupply(contractAddress), () => {
    ...
    invariant("totalUnclaimedSupply" in contract && contract.totalUnclaimedSupply, "Contract instance does not support fetching unclaimed supply");
...
function useClaimedNFTSupply(contract) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.nft.drop.totalClaimedSupply(contractAddress), () => {
    ...
    invariant("totalClaimedSupply" in contract && contract.totalClaimedSupply, "Contract instance does not support fetching unclaimed supply");
...
function useClaimToken(contract) {
  ...
  return useMutation(async data => {
    ...
    if (erc20) {
      invariant(erc20 === null || erc20 === void 0 ? void 0 : erc20.claimTo, "contract does not support claimTo");
...
function useTransferToken(contract) {
  ...
  return useMutation(data => {
    ...
    if (erc20) {
      invariant(erc20 === null || erc20 === void 0 ? void 0 : erc20.transfer, "contract does not support transfer");
...
function useTransferBatchToken(contract) {
  ...
  return useMutation(data => {
    if (erc20) {
      invariant(erc20 === null || erc20 === void 0 ? void 0 : erc20.transferBatch, "contract does not support transferBatch");
...
function useBurnToken(contract) {
  ...
  return useMutation(data => {
    ...
    if (erc20) {
      invariant(erc20 === null || erc20 === void 0 ? void 0 : erc20.burn, "contract does not support burn");
...
function useActiveClaimCondition(contract, tokenId) {
  ...
  return useQueryWithNetwork(cacheKeys.extensions.claimConditions.getActive(contractAddress, tokenId), () => {
    if (erc1155) {
      invariant(tokenId !== undefined, "tokenId is required for ERC1155 claim conditions");
...
export { useAuctionWinner as $, useNFT as A, useNFTs as B, useTotalCount as C, useTotalCirculatingSupply as D, useOwnedNFTs as E, useNFTBalance as F, useMintNFT as G, useMintNFTSupply as H, useTransferNFT as I, useAirdropNFT as J, useBurnNFT as K, useUnclaimedNFTs as L, useClaimedNFTs as M, useUnclaimedNFTSupply as N, useClaimedNFTSupply as O, useBatchesToReveal as P, useClaimNFT as Q, useLazyMint as R, useDelayedRevealLazyMint as S, ThirdwebSDKProvider as T, useRevealLazyMint as U, useListing as V, WrappedThirdwebSDKProvider as W, useListings as X, useListingsCount as Y, useActiveListings as Z, useWinningBid as _, useDesiredChainId as a, ConnectWallet as a$, useBidBuffer as a0, useCreateDirectListing as a1, useCreateAuctionListing as a2, useCancelListing as a3, useMakeBid as a4, useBuyNow as a5, useTokenSupply as a6, useTokenBalance as a7, useTokenDecimals as a8, useMintToken as a9, useUser as aA, useStorage as aB, useStorageUpload as aC, useSigner as aD, useReadonlySDK as aE, useNetworkMismatch as aF, useBalance as aG, useConnectedWallet as aH, useAddress as aI, useChainId as aJ, useAccount as aK, useNetwork as aL, useDisconnect as aM, useConnect as aN, useMetamask as aO, useWalletConnect as aP, useCoinbaseWallet as aQ, useWalletLink as aR, useGnosis as aS, useMagic as aT, getErcs as aU, getErc1155 as aV, getErc721 as aW, getErc20 as aX, MediaRenderer as aY, useResolvedMediaType as aZ, ThirdwebNftMedia as a_, useClaimToken as aa, useTransferToken as ab, useTransferBatchToken as ac, useBurnToken as ad, useActiveClaimCondition as ae, useClaimConditions as af, useClaimIneligibilityReasons as ag, useSetClaimConditions as ah, useResetClaimConditions as ai, usePrimarySaleRecipient as aj, useUpdatePrimarySaleRecipient as ak, useRoyaltySettings as al, useUpdateRoyaltySettings as am, usePlatformFees as an, useUpdatePlatformFees as ao, useMetadata as ap, useUpdateMetadata as aq, useAllRoleMembers as ar, useRoleMembers as as, useIsAddressRole as at, useSetAllRoleMembers as au, useGrantRole as av, useRevokeRole as aw, useAuth as ax, useLogin as ay, useLogout as az, useSDKChainId as b, Web3Button as b0, ThirdwebProvider as c, useEditionDrop as d, useEdition as e, useNFTDrop as f, useMarketplace as g, useNFTCollection as h, usePack as i, useToken as j, useTokenDrop as k, useVote as l, useSplit as m, useMultiwrap as n, useSignatureDrop as o, useContractType as p, contractType as q, useCompilerMetadata as r, compilerMetadata as s, useContract as t, useSDK as u, useContractMetadata as v, useContractMetadataUpdate as w, useContractEvents as x, useContractRead as y, useContractWrite as z };
