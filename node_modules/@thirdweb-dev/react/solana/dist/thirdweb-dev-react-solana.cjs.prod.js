...
var queryKey = require('../../dist/query-key-b2e9846d.cjs.prod.js');
...
function claimConditionsQuery(program) {
  return {
    queryKey: queryKey.createSOLProgramQueryKey(program, ["claimConditions"]),
    queryFn: async () => {
      invariant__default["default"](program, "program is required");
...
function balanceQuery(sdk) {
  ...
  const network = sdk === null || sdk === void 0 ? void 0 : sdk.network;
  return {
    queryKey: queryKey.createSOLQueryKeyWithNetwork(["wallet-balance", {
      address
    }], network),
    queryFn: () => {
      invariant__default["default"](sdk, "sdk is required");
